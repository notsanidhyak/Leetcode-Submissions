    ...
    public int minExtraChar(String s, String[] dictionary) {
        ...
        for (int i = 1; i <= n; i++) {
            ...
            for (int j = 0; j < i; j++) {
                ...
                // If substring found in dictionary
                if (dict.contains(sub)) dp[i] = Math.min(dp[i], dp[j]); 
            }
